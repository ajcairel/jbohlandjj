      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <form
          ...
          <p className="leading-relaxed mb-5">
            My schedule is always changing but if you would like to schedule a private lesson with me,
            shoot me a message! 
          </p>
          ...
          <button
            type="submit"
            className="text-white bg-blue-300 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            Submit
          </button>
        </form>
      </div>
